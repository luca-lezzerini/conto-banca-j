...
public class EstrattoCPController {
    ...
    @ResponseBody
    @RequestMapping("/mov-cp")

    public ListaMovCpDto estrattoContoCp(@RequestBody ContoPrestitoDto dto) {

        return estrattoCPService.estrattoContoCp(dto.getContoPrestito());
    }
}
